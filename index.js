define(['exports', 'async', 'logdown', 'superagent', './PromiseMaker', './EventEmitter', './ConnectingMessageBuffer', './Constants', './transports/index'], function (exports, _async, _logdown, _superagent, _PromiseMaker, _EventEmitter2, _ConnectingMessageBuffer, _Constants, _index) {
  'use strict';
...
define(['exports', 'lodash.sum', 'lodash'], function (exports, _lodash, _lodash3) {
  'use strict';
...
define(['exports', 'superagent', 'logdown', './Constants', './Client', './HubProxy', './Protocol', './PromiseMaker', 'lodash'], function (exports, _superagent, _logdown, _Constants, _Client2, _HubProxy, _Protocol, _PromiseMaker, _lodash) {
  'use strict';
...
define(['exports', 'lodash', 'logdown', './Protocol', './EventEmitter'], function (exports, _lodash, _logdown, _Protocol, _EventEmitter2) {
  'use strict';
...
define(['exports', './Client'], function (exports, _Client) {
  'use strict';
...
define(['exports', './ServerSentEventsTransport', './LongPollingTransport', './WebSocketTransport', './NullTransport'], function (exports, _ServerSentEventsTransport, _LongPollingTransport, _WebSocketTransport, _NullTransport) {
   'use strict';
...
define(['exports', 'lodash', 'superagent', './Transport', '../PromiseMaker', '../Constants'], function (exports, _lodash, _superagent, _Transport2, _PromiseMaker, _Constants) {
  'use strict';
...
define(['exports', './Transport'], function (exports, _Transport2) {
  'use strict';
...
define(['exports', './Transport', '../Constants', 'eventsource', 'superagent', '../PromiseMaker'], function (exports, _Transport2, _Constants, _eventsource, _superagent, _PromiseMaker) {
  'use strict';
...
define(['exports', 'logdown', '../Protocol', '../Constants', 'lodash.takeright', '../EventEmitter'], function (exports, _logdown, _Protocol, _Constants, _lodash, _EventEmitter2) {
  'use strict';
...
define(['exports', './Transport', '../Constants'], function (exports, _Transport2, _Constants) {
  'use strict';
